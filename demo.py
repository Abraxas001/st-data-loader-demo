...
with st.sidebar:
        ...
        st.write("By default this app will through an error as we are not connected to a snowflake account yet. Enter you Username and Password to connect and enjoy this app. Thanks!", color:Blue)
